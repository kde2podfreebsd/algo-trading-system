...
class MomentumIndicators(TAInterface):
    ...
    def ADX(df: DataFrame, timeperiod: int):
        output = df
        output[f'ADX {timeperiod}'] = talib.ADX(df['High'], df['Low'], df['Close'], timeperiod=timeperiod)
        return output
    ...
    def ADXR(df: DataFrame, timeperiod: int):
        output = df
        output[f'ADRX {timeperiod}'] = talib.ADXR(df['High'], df['Low'], df['Close'], timeperiod=timeperiod)
        return output
    ...
    def APO(df: DataFrame, fastperiod: int, slowperiod: int, matype: int):
        output = df
        output[f'APO {fastperiod} {slowperiod}'] = talib.APO(df['Close'], fastperiod=fastperiod, slowperiod=slowperiod, matype=matype)
        return output
    ...
    def AROON(df: DataFrame, timeperiod:int):
        output = df
        output[f'AROON_down {timeperiod}'], output[f'AROON_up {timeperiod}'] = talib.AROON(df['High'], df['Low'], timeperiod=timeperiod)
        return output
    ...
    def AROONOSC(df: DataFrame, timeperiod:int):
        output = df
        output[f'AROONOSC {timeperiod}'] = talib.AROONOSC(df['High'], df['Low'], timeperiod=timeperiod)
        return output
    ...
    def CCI(df: DataFrame, timeperiod: int):
        output = df
        output[f'CCI {timeperiod}'] = talib.CCI(df['High'], df['Low'], df['Close'], timeperiod=timeperiod)
        return output
    ...
    def DX(df: DataFrame, timeperiod: int):
        output = df
        df[f'DX {timeperiod}'] = talib.DX(df['High'], df['Low'], df['Close'], timeperiod=timeperiod)
        return output

    @TAInterface.is_valid_dataframe
    @staticmethod
    def MACD(df: DataFrame, fastperiod: int, slowperiod: int, signalperiod: int) -> DataFrame:
        output = df
    ...
    @TAInterface.is_valid_dataframe
    @staticmethod
    def MACDEXT(df: DataFrame, fastperiod: int, fastmatype: int, slowperiod: int, slowmatype: int, signalperiod: int, signalmatype: int):
        output = df
    ...
    def MFI(df: DataFrame, timeperiod: int):
        output = df
        df[f'MFI {timeperiod}'] = talib.MFI(df['High'], df['Low'], df['Close'], df['Volume'], timeperiod=timeperiod)
        return output
    ...
    def MINUS_DI(df: DataFrame, timeperiod: int):
        output = df
        output[f'MINUS_DI {timeperiod}'] = talib.MINUS_DI(df['High'], df['Low'], df['Close'], timeperiod=timeperiod)
        return output
    ...
    def MINUS_DM(df: DataFrame, timeperiod):
        output = df
        output[f'MINUS_DM {timeperiod}'] = talib.MINUS_DM(df['High'], df['Low'], timeperiod=timeperiod)
        return output
    ...
    def PLUS_DI(df: DataFrame, timeperiod: int):
        output = df
        output[f'PLUS_DI {timeperiod}'] = talib.PLUS_DI(df['High'], df['Low'], df['Close'], timeperiod=timeperiod)
        return output
    ...
    def PLUS_DM(df: DataFrame, timeperiod: int):
        output = df
        output[f'PLUS_DM {timeperiod}'] = talib.PLUS_DM(df['High'], df['Low'], timeperiod=timeperiod)
        return output
    ...
    def PPO(df: DataFrame, fastperiod: int, slowperiod: int, matype: int):
        output = df
        output[f'PPO {fastperiod} {slowperiod}'] = talib.PPO(df['Close'], fastperiod=fastperiod, slowperiod=slowperiod, matype=matype)
        return output
    ...
    def ROCR100(df: DataFrame, timeperiod: int):
        output = df
        output[f'ROCR100 {timeperiod}'] = talib.ROCR100(df['Close'], timeperiod=timeperiod)
        return output
    ...
    def WILLR(df: DataFrame, timeperiod: int):
        output = df
        output[f'WILLR {timeperiod}'] = talib.WILLR(df['High'], df['Low'], df['Close'], timeperiod=timeperiod)
        return output
